...
import com.example.wordgame.adapters.MyAdapter;

import java.util.ArrayList;
import java.util.Collections;

public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private String[] words = {"Hemant", "chand", "softwarica", "coventry", "android", "assignment"};
    ...
    private void showWord(int i){
        MyAdapter myAdapter = new MyAdapter(MainActivity.this, shuffleWords(i), editTextWord);
